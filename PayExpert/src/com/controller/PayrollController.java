...
public class PayrollController {
	...
	while(true) {
		...
		case 1: 
			...
			payroll.setEmployee_id(sc.nextInt());
			break;
		...
		case 3:
			...
			try {
				...
				for (Employee emp : empList) {
			        double overtimePay = payrollService.calculateOvertimePay(emp); // Assuming there's a method to calculate overtime pay for each employee
			        System.out.println("Employee ID: " + emp.getUser_Id() + ", Overtime Pay: " + overtimePay);
			    }
			} catch (SQLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
